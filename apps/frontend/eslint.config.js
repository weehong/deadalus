...
const typescriptConfig = {
  ...
  rules: {
    ...
    // Underscore-prefixed args are intentionally unused (e.g. the production
    // no-op component in TanStackDevelopmentTools.tsx, which must keep its
    // props signature). Encode that convention rather than edit the sources.
